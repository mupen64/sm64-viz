...
Actions = {
	...
	ACTION = {
		...
		{ name = "hold panting",               value = 0x08000206 },
		...
		{ name = "shockwave bouncing",         value = 0x00020226 },
		...
		{ name = "unlocking door text",        value = 0x20001305 },
		{ name = "text",                       value = 0x20001306 },
		{ name = "star dance no exit",         value = 0x00001307 },
		{ name = "reading sign",               value = 0x00001308 },
		{ name = "grabbed grand star",         value = 0x00001909 },
		{ name = "waiting for text",           value = 0x0000130A },
		{ name = "free movement",              value = 0x0000130F },
		...
		{ name = "appearing from door",        value = 0x00001322 },
		{ name = "emerge from pipe",           value = 0x00001923 },
		{ name = "spinning enter",             value = 0x00001924 },
		{ name = "spinning enter land",        value = 0x00001325 },
		{ name = "star exit sideways",         value = 0x00001926 },
		{ name = "star exit land",             value = 0x00001327 },
		{ name = "death exit sideways",        value = 0x00001928 },
		{ name = "death exit freefall",        value = 0x00001929 },
		{ name = "death exit downwards",       value = 0x0000192A },
		{ name = "star exit upwards",          value = 0x0000192B },
		{ name = "death exit upwards",         value = 0x0000192C },
		{ name = "star exit downwards",        value = 0x0000192D },
		{ name = "unlocking key door",         value = 0x0000132E },
		{ name = "unlocking door",             value = 0x0000132F },
		{ name = "entering star door",         value = 0x00001331 },
		{ name = "neutral enter",              value = 0x00001932 },
		{ name = "neutral enter land",         value = 0x00001333 },
