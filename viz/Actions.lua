...
Actions = {
	...
	ACTION = {
		...
		{ name = "unknown 006",                value = 0x08000206 },
		{ name = "unknown 007",                value = 0x08000207 },
		{ name = "unknown 008",                value = 0x08000208 },
		...
		{ name = "unknown 022",                value = 0x0C008222 },
		{ name = "start crawling",             value = 0x0C008223 },
		{ name = "unknown 024",                value = 0x0C008224 },
		{ name = "slide kick slide stop",      value = 0x08000225 },
		{ name = "unknown 026",                value = 0x00020226 },
		...
		{ name = "unknown 034",                value = 0x08000234 },
		{ name = "unknown 035",                value = 0x08000235 },
		...
		{ name = "unknown 03f",                value = 0x0800043F },
		...
		{ name = "unknown 105",                value = 0x20001305 },
		{ name = "unknown 106",                value = 0x20001306 },
		{ name = "star dance no exit",         value = 0x00001307 },
		{ name = "reading sign",               value = 0x00001308 },
		{ name = "grabbed grand star",         value = 0x00001909 },
		{ name = "unknown 10a",                value = 0x0000130A },
		{ name = "unknown 10f",                value = 0x0000130F },
		...
		{ name = "unknown 122",                value = 0x00001322 },
		{ name = "emerge from pipe",           value = 0x00001923 },
		{ name = "unknown 124",                value = 0x00001924 },
		{ name = "unknown 125",                value = 0x00001325 },
		{ name = "unknown 126",                value = 0x00001926 },
		{ name = "unknown 127",                value = 0x00001327 },
		{ name = "unknown 128",                value = 0x00001928 },
		{ name = "unknown 129",                value = 0x00001929 },
		{ name = "unknown 12a",                value = 0x0000192A },
		{ name = "unknown 12b",                value = 0x0000192B },
		{ name = "unknown 12c",                value = 0x0000192C },
		{ name = "unknown 12d",                value = 0x0000192D },
		{ name = "unlocking key door",         value = 0x0000132E },
		{ name = "unknown 12f",                value = 0x0000132F },
		{ name = "entering star door",         value = 0x00001331 },
		{ name = "unknown 132",                value = 0x00001932 },
		{ name = "unknown 133",                value = 0x00001333 },
		...
		{ name = "unknown 183",                value = 0x00000383 },
		{ name = "unknown 185",                value = 0x00000385 },
		{ name = "unknown 186",                value = 0x00000386 },
		{ name = "unknown 187",                value = 0x00000387 },
		{ name = "throwing",                   value = 0x80000588 },
		{ name = "unknown 189",                value = 0x80000589 },
		{ name = "unknown 190",                value = 0x00000390 },
